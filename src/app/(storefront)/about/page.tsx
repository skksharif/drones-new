          ...
          <div>
            <Reveal>
              ...
              <div className="mt-5 space-y-4 text-sm leading-relaxed text-ink-600 sm:text-[0.9375rem]">
                ...
                <p>
                  At {siteConfig.name}, we are pioneering advancements in agriculture spraying
                  drones, human-flying drones, surveillance drones, firefighting drones, and more. Our
                ...
                <p>
                  We believe that drones are the future of smart technology, and at {siteConfig.name} we
                  are committed to pushing the boundaries of innovation to create a world where drones
